...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/views/style/cart.css">
</head>
<body>
	...
	<main>
		...
		<c:if test="${not empty cartItems}">
			<div class="cart-container">
				<!-- Step indicator -->
				<div class="step-bar">
					<span class="step-active">Step1. Cart</span> ▶ <span
						class="step-inactive">Step2. Order</span> ▶ <span
						...
						<div class="quantity-controls">
							<form action="${pageContext.request.contextPath}/cart"
								...
								<input type="hidden" name="action" value="update"> <input
									...
									type="hidden" name="quantity" value="${cart.quantity - 1}">
				...
				<div class="cart-actions">
					<a
						href="${pageContext.request.contextPath}/views/product/ProductList"
						class="continue-shopping">買い物を続く</a> <a
						href="${pageContext.request.contextPath}/order" class="order-btn">注文する</a>
				</div>
			</div>
		</c:if>
	</main>
